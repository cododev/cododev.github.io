...
{
$complainno=$_POST['complaintNumber'];
$uid=$_SESSION['id'];
...
$query=mysqli_query($con,"insert into tblcomplaints(complaintNumber, userId,category,subcategory,complaintDetails,complaintFile) values('$complainno','$uid','$category','$subcat','$complaintdetials','$compfile')");
...
$complainno=$cmpn;
echo '<script> alert("Your complain has been successfully lodged. Your complainno is "+"'.$complainno.'")</script>';
}
?>
...
<html lang="en">
  <head>
    ...
    <title>AAU HELPDESK | User Register Complaint</title>
