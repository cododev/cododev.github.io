...
<tbody>
									...
									$query=mysqli_query($con,"SELECT tblcomplaints.*,
															users.fullName as fname from tblcomplaints 
									...
									?>										
										<tr>
											<td><?php print htmlentities($row['complaintNumber']);?></td>
											<td><?php print htmlentities($row['fname']);?></td>
